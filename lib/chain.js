 ...
 * @returns {Verdict}
 */
function validate (manifests, specs) {
  /** @type {Problem[]} */
  const problems = []
  ...
  for (const spec of all) {
    ...
    portProblems(spec, kind, byId, set, declared, supply, problems)
  }
 ...
 * @param {Problem[]} out
 */
function portProblems (spec, kind, byId, manifests, declared, supply, out) {
...
module.exports = { validate, explain, visible, substitution, NATIVE }
